    ...
    <ScreenWrapper title="Terms & Conditions">
      ...
      >
        <ContentCard>
          ...
          >
            By registering for an account with Sweepsteak Ltd ("we," "us," or "our") and accessing
            and using our website and services, users ("you," "your") agree to be bound by these
            Terms and Conditions. If you do not agree to these Terms and Conditions, do not use our
            services.
          </Typography>
          ...
          <Typography
            ...
            style={{ marginLeft: 10, marginBottom: 4 }}
          >
            • You must not be a professional golfer competing in any professional tour at the time
            of entry
          </Typography>
          <Typography
            variant="body"
          ...
          <Typography
            ...
            style={{ marginBottom: 8 }}
          >
            To use our services, you must register an account. You must provide accurate, complete,
            and up-to-date information. You are responsible for maintaining the confidentiality of
            your account and password. You are responsible for all activities that occur under your
            account.
          </Typography>
          <Typography
            variant="body"
          ...
          <Typography
            ...
            style={{ marginBottom: 8 }}
          >
            We reserve the right to suspend or close accounts if we believe you have breached these
          ...
          <Typography
            ...
            style={{ marginLeft: 10, marginBottom: 4 }}
          >
            • Creating or using multiple accounts will result in the immediate closure of all
            accounts
          </Typography>
          <Typography
            variant="body"
          ...
          <Typography
            ...
            style={{ marginBottom: 8 }}
          >
            All financial transactions are processed securely. We are not liable for any losses you
            incur as a result of any transaction or banking services.
          </Typography>
          ...
          <Typography
            ...
            style={{ marginBottom: 8 }}
          >
            We are not responsible for any losses or damages incurred through the use of our
            services. We make no warranties about the accuracy, reliability, or availability of the
            platform.
          </Typography>
